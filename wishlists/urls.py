...
urlpatterns = [
    ...
    path("soft_add_to_wishlist/<int:product_id>/", soft_add_to_wishlist, name="soft_add_to_wishlist"),
    path("remove_from_wishlist/<int:product_id>/", remove_from_wishlist, name="remove_from_wishlist"),
    path("soft_remove_from_wishlist/<int:product_id>/", soft_remove_from_wishlist, name="soft_remove_from_wishlist"),
