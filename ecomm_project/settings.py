...
SECRET_KEY = "django-insecure-)g#6-k(&yfz#pp(n5#lh2xge1nwrx%-!#2=+*(2m6xip)4i(^4"
...
INSTALLED_APPS = [
    ...
    # STEP 21: Register the category app and go to models.py of the category app
    "category",
    "accounts",
    "store",
    "carts",
...
TEMPLATES = [
    {
        ...
        # STEP 3: add the templates folder here as below
        # STEP 4: go to urls.py file and add the url
        "DIRS": ['templates'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "static/"
# STEP 8: Make the static_root variable here!
STATIC_ROOT = BASE_DIR / 'static'
STATICFILES_DIRS = [
    "ecomm_project/static",
]
# STEP 9: After adding above 2 lines, run python manage.py collectstatic
# STEP 10: Go to home.html file and load the static
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "rajamaulik16@gmail.com"
EMAIL_HOST_PASSWORD = "gdzbbgtsymnsygps"